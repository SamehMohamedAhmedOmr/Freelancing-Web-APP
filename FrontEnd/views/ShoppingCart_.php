...
// FOR TESTING (in Home Page):-
  // $servicesInShppingCart=array(array('date'=>'2017-12-25 00:00:00','s_id'=>4,'name'=>'Service 3','price'=>3850,'status'=>0,'c_name'=>'mohamed','c_id'=>73));
  // $servicesInShppingCart[]=array('date'=>'2017-12-25 00:00:00','s_id'=>5,'name'=>'web designer','price'=>365,'status'=>1,'c_name'=>'zezo','c_id'=>6);
        ...
        if(isset($_COOKIE['ShoppingCart']))
        {
          ...
          if(sizeof($servicesInShppingCart) !=0)
          {
            foreach ($servicesInShppingCart as $row) {
              $sc->AddtoCart($clientID,$row['s_id'],$row['date'],$client->db_connection);
            }
          }
          $servicesInShppingCart=array();
          setcookie ("ShoppingCart",serialize($servicesInShppingCart),time()+ 86400*30,"/"); // 1 day
